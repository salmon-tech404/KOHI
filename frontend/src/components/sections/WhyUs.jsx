      ...
      <div className='max-w-6xl mx-auto'>
        <div className='grid divide-y md:grid-cols-3 md:divide-y-0 md:divide-x divide-white/10'>
          {MENU_ITEMS.map((item, i) => (
            ...
            >
              <span className='block mb-6 font-serif transition-colors duration-300 text-7xl text-gold/50 group-hover:text-gold'>
                0{i + 1}
              </span>
              <h3 className='mb-3 item-title'>{item.title}</h3>
